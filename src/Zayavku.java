...
public class Zayavku {
	...
	protected void createContents() {
		try {
		InputStream true_image = Zayavku.class.getClassLoader().getResourceAsStream("OK.png");
		InputStream false_image = Zayavku.class.getClassLoader().getResourceAsStream("Denied.png");
		//trueImage = new Image(display, new FileInputStream("./icon/OK.png"));
	...
	private static void db_connect() {
		try {
			String url = "jdbc:postgresql://192.168.33.116/zayavka";
