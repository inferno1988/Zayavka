...
public class Zayavku {
	...
	protected void createContents() {
		trueImage = new Image(display, "icons/OK.png");
		falseImage = new Image(display, "icons/Denied.png");
	...
	private static void select_all(int status) {
		...
		try {
			...
			ResultSet rs = st
					.executeQuery("SELECT sorting, kv, login, zayavka_error.name, date, time ,status, domtel, mobtel, zayavka_worker.name, comments "
